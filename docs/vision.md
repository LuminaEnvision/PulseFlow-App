...
Pulse turns these **inputs into signals** that help you:

- Understand patterns
- Reduce decision fatigue
- Adapt daily routines
- Make better choices without constant tracking or analysis
...
Pulse grows with its users:

- **MVP 1**: "Pulse helps me understand today."
- **MVP 2**: "Pulse understands me."

Everyday usefulness first. Depth second.

---

📖 See also: [Product](./product.md) | [Roadmap](./roadmap.md) | [Token Utility](./token-utility.md)
